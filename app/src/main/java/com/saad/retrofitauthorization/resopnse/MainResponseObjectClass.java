...
public class MainResponseObjectClass {
    ...
    public MainResponseObjectClass(String tsyncId, String name, String email,
                                   String phone, String fullAddress, String nameOfUniversity,
                                   long graduationYear, double cgpa, long experienceInMonths,
                                   String currentWorkPlaceName, String applyingIn, long expectedSalary,
                                   String fieldBuzzReference, CvFile cvFile, long onSpotUpdateTime,
                                   long onSpotCreationTime, boolean success, String message) {
        super();
